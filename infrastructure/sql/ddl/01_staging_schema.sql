...
CREATE TABLE IF NOT EXISTS staging.members_raw (
    ...
    call_count SMALLINT,
    app_login_count SMALLINT,
    web_login_count SMALLINT,
...
CREATE TABLE IF NOT EXISTS staging.claims_raw (
    ...
    diagnosis_code TEXT,
    procedure_code TEXT,
    -- Additional descriptor and metric base columns per objective.md
    charges NUMERIC(12, 2),
    allowed NUMERIC(12, 2),
    clean_claim_status TEXT,
    claim_from DATE,
    clean_claim_out DATE,
    utilization NUMERIC(12, 2),
...
CREATE INDEX IF NOT EXISTS idx_claims_raw_provider ON staging.claims_raw (
    provider_id
);
